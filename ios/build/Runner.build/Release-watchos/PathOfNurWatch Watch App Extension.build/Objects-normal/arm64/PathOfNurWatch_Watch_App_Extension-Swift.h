...
#ifndef PATHOFNURWATCH_WATCH_APP_EXTENSION_SWIFT_H
#define PATHOFNURWATCH_WATCH_APP_EXTENSION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PathOfNurWatch_Watch_App_Extension",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC34PathOfNurWatch_Watch_App_Extension22WatchExtensionDelegate")
@interface WatchExtensionDelegate : NSObject <WKApplicationDelegate>
...
SWIFT_CLASS("_TtC34PathOfNurWatch_Watch_App_Extension34WatchPrayerNotificationCoordinator")
@interface WatchPrayerNotificationCoordinator : NSObject <UNUserNotificationCenterDelegate>
...
@class WCSession;
@class NSString;
SWIFT_CLASS("_TtC34PathOfNurWatch_Watch_App_Extension16WatchSyncService")
@interface WatchSyncService : NSObject <WCSessionDelegate>
