...
final kidsArabicMiniPhrasesProvider = Provider<List<KidsArabicMiniPhrase>>((
  ref,
) {
  return kidsArabicMiniPhrases;
});

final kidsArabicMiniPhraseProgressProvider =
    StateNotifierProvider<
      KidsArabicMiniPhraseProgressNotifier,
      KidsArabicMiniPhraseProgressState
    >((ref) {
...
final kidsArabicMiniPhraseRecommendedProvider = Provider<KidsArabicMiniPhrase?>(
  (ref) {
...
class KidsArabicMiniPhraseProgressNotifier
  ...
  void updateActiveLearner(String learnerId) {
    ...
    state = KidsArabicMiniPhraseProgressState.fromJson(
      _store.getJsonMap(
        kidsArabicMiniPhraseProgressStorageKeyForLearner(learnerId),
      ),
    );
  }
  ...
  void markPhraseHeard(String phraseId) {
    ...
    state = state.copyWith(heardPhraseIds: nextHeard, lastPhraseId: phraseId);
    _save();
  }
}
