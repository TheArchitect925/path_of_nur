...
''',
    lesson:
        'Everyone makes mistakes, but Allah loves those who turn back to Him and try again.',
    quranQuote:
    ...
    quranQuoteRef: QuranQuoteRef(surah: 2, ayah: 37),
...
''',
    ...
    sortOrder: 20,
    coverAssetPath: '$bedtimeStoryImageAssetDirectory/nuh_cover.webp',
    backdropAssetPath: '$bedtimeStoryImageAssetDirectory/nuh_backdrop.webp',
    narratorDisplayName: _narratorDisplayName,
    isLocked: false,
    unlockXp: 0,
    oceanDropsReward: 1,
...
''',
    ...
    quranQuoteRef: QuranQuoteRef(surah: 21, ayah: 69),
...
''',
    lesson:
        'Trust Allah, even when things feel difficult. Allah rewards those who are patient and sincere.',
    quranQuote:
        'O my father, do as you are commanded. You will find me, if Allah wills, among the patient.',
    quranReference: 'Qur’an 37:102',
    quranQuoteRef: QuranQuoteRef(surah: 37, ayah: 102),
...
''',
    ...
    sortOrder: 50,
    coverAssetPath: '$bedtimeStoryImageAssetDirectory/yusuf_cover.webp',
    backdropAssetPath: '$bedtimeStoryImageAssetDirectory/yusuf_backdrop.webp',
    narratorDisplayName: _narratorDisplayName,
    isLocked: false,
    unlockXp: 0,
    oceanDropsReward: 1,
...
''',
    lesson:
        'Trust Allah even in scary times, be brave, and stand up for what is right.',
    quranQuote:
    ...
    quranQuoteRef: QuranQuoteRef(surah: 26, ayah: 63),
...
''',
    ...
    sortOrder: 70,
    coverAssetPath: '$bedtimeStoryImageAssetDirectory/yunus_cover.webp',
    backdropAssetPath: '$bedtimeStoryImageAssetDirectory/yunus_backdrop.webp',
    narratorDisplayName: _narratorDisplayName,
    isLocked: false,
    unlockXp: 0,
    oceanDropsReward: 1,
...
''',
    lesson:
        'True strength comes from trusting Allah. Be fair, helpful, and use your gifts for good.',
    quranQuote:
    ...
    quranQuoteRef: QuranQuoteRef(surah: 34, ayah: 10),
    estimatedDurationSeconds: 120,
    isFeatured: true,
    isMultipart: false,
    partNumber: 1,
...
''',
    ...
    quranQuoteRef: QuranQuoteRef(surah: 3, ayah: 59),
    estimatedDurationSeconds: 120,
    isFeatured: true,
    isMultipart: false,
    partNumber: 1,
...
''',
    lesson:
        'Be grateful for what you have, use your gifts for good, and stay humble.',
    quranQuote:
    ...
    quranQuoteRef: QuranQuoteRef(surah: 27, ayah: 19),
...
''',
    lesson:
        'Stand for what is right, be patient, and let kindness lead the way.',
    quranQuote:
        'So be patient, as were those of determination among the messengers.',
    quranReference: 'Qur’an 46:35',
    quranQuoteRef: QuranQuoteRef(surah: 46, ayah: 35),
...
''',
    lesson:
        'Forgive others, be kind, be fair, and follow the beautiful example of the Prophet ﷺ.',
    quranQuote:
        'There has certainly come to you a Messenger from among yourselves. Grievous to him is what you suffer; he is concerned over you and to the believers is kind and merciful.',
    quranReference: 'Qur’an 9:128',
    quranQuoteRef: QuranQuoteRef(surah: 9, ayah: 128),
    estimatedDurationSeconds: 120,
    isFeatured: false,
    isMultipart: true,
    partNumber: 4,
