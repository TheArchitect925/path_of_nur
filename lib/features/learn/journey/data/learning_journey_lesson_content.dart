...
final Map<String, LearningJourneyLessonContent> _seerahLessons =
    <String, LearningJourneyLessonContent>{
...
final Map<String, LearningJourneyLessonContent> _dhikrLessons =
    <String, LearningJourneyLessonContent>{
      ...
      'dhikr-after-salah': _lesson(
        ...
        invocations: const [
          LearningJourneyLessonInvocation(
            ...
            arabic: 'سُبْحَانَ اللَّهِ ٣٣ • الْحَمْدُ لِلَّهِ ٣٣ • اللَّهُ أَكْبَرُ ٣٤',
            transliteration:
...
final Map<String, LearningJourneyLessonContent> _aqeedahLessons =
    <String, LearningJourneyLessonContent>{
...
final Map<String, LearningJourneyLessonContent> _duaLessons =
    <String, LearningJourneyLessonContent>{
      ...
      'duas-leaving-home': _lesson(
        ...
        sections: [
          _section(
            title: 'When to use',
            body: 'Say this when you leave your home for school, work, errands, or travel.',
          ),
        ],
      ...
      'duas-gratitude': _lesson(
        ...
        invocations: const [
          LearningJourneyLessonInvocation(
            ...
            context: 'A gratitude dua linked to blessings, parents, and righteous action.',
...
final Map<String, LearningJourneyLessonContent> _quranPathLessons =
    <String, LearningJourneyLessonContent>{
      'quran-open': _lesson(
        stageId: 'quran-open',
      ...
      'short-surahs-explore': _lesson(
        ...
        quranReferences: const ['Qur’an 112:1-4', 'Qur’an 113:1-5', 'Qur’an 114:1-6'],
      ...
      'recite-fatihah': _lesson(
        ...
        invocations: const [
          LearningJourneyLessonInvocation(
            ...
            context: 'Said throughout salah, especially at the opening and movement transitions.',
            sourceReference: 'Sahih Muslim',
          ),
        ],
        relatedTools: const [_lessonSalahHubTool, _lessonQuranReaderTool],
      ...
      'recite-short-surahs': _lesson(
        ...
        invocations: const [
          ...
          LearningJourneyLessonInvocation(
            ...
            context: 'Said in gratitude, daily speech, and throughout recitation and dhikr.',
      ...
      'recite-meaning': _lesson(
        ...
        invocations: const [
          LearningJourneyLessonInvocation(
            ...
            context: 'Said after mistakes, after salah, and whenever the heart needs to return.',
            sourceReference: 'Sahih Muslim',
          ),
          LearningJourneyLessonInvocation(
            ...
            context: 'The foundation of faith and one of the greatest forms of dhikr.',
...
final Map<String, LearningJourneyLessonContent> _fiqhLessons =
    <String, LearningJourneyLessonContent>{
      'fiqh-intro': _lesson(
        stageId: 'fiqh-intro',
        title: 'What fiqh is',
...
final Map<String, LearningJourneyLessonContent> _timelineLessons =
    <String, LearningJourneyLessonContent>{
      ...
      'timeline-khulafa': _lesson(
        ...
        sourceReferences: const ['Sahih al-Bukhari', 'Classical early-history summaries'],
        relatedTools: const [_lessonProphetsTool, _lessonLegacyLearnTool],
      ),
...
final Map<String, LearningJourneyLessonContent> _tajweedLessons =
    <String, LearningJourneyLessonContent>{
...
final Map<String, LearningJourneyLessonContent> _dailyWisdomLessons =
    <String, LearningJourneyLessonContent>{
...
final Map<String, LearningJourneyLessonContent> _storiesSignsLessons =
    <String, LearningJourneyLessonContent>{
