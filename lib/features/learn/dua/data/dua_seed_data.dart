...
const duaSeedDataset = DuaDataset(
  ...
  notes: <String>[
    ...
    'Unnamed planned placeholders remain for future curation where the product intent is not yet specific enough for source-safe completion.',
  ...
  items: <DuaItem>[
    ...
    DuaItem(
      ...
      whenToSay: 'When waking during the night before making dua or praying.',
      sourceType: 'sunnah',
    ...
    DuaItem(
      ...
      arabic: 'اَللّٰهُمَّ أَطْعِمْ مَنْ أَطْعَمَنِيْ وَاسْقِ مَنْ سَقَانِي.',
    ...
    DuaItem(
      ...
      arabic: 'اَللّٰهُمَّ صَلِّ عَلَىٰ مُحَمَّدٍ وَّعَلَىٰ اٰلِ مُحَمَّدٍ.',
    ...
    DuaItem(
      ...
      whenToSay: 'When congratulating parents on the birth of a newborn child.',
    ...
    DuaItem(
      ...
      translation:
          'My Lord, have mercy on them as they raised me when I was small.',
      whenToSay: 'For one\'s living parents and in gratitude for their care.',
      sourceType: 'Qur\'an',
      sourceRef: 'Qur\'an 17:24.',
      difficulty: DuaDifficulty.beginner,
    ...
    DuaItem(
      ...
      whenToSay: 'During travel when going up elevated ground or descending.',
      sourceType: 'Hadith',
    ...
    DuaItem(
      ...
      sourceType: 'Hadith / Qur\'an citation',
      sourceRef: 'Hisn al-Muslim 207; Muslim 2/978; includes Qur\'an 43:13-14.',
      difficulty: DuaDifficulty.beginner,
    ...
    DuaItem(
      ...
      sourceType: 'Hadith',
      sourceRef: 'Hisn al-Muslim 120; Ahmad 1/391; authenticated by al-Albani.',
      difficulty: DuaDifficulty.beginner,
    ...
    DuaItem(
      ...
      translation: 'Indeed we belong to Allah, and indeed to Him we return.',
    ...
    DuaItem(
      ...
      sourceType: 'Hadith',
      sourceRef: 'Hisn al-Muslim 237; At-Tirmidhi; graded good by al-Albani.',
      difficulty: DuaDifficulty.beginner,
    ...
    DuaItem(
      ...
      difficulty: DuaDifficulty.beginner,
      tags: <String>['guidance', 'taqwa', 'uprightness', 'self_sufficiency'],
      audioKey: '',
      isCore: false,
      verificationStatus: 'source_seeded_sunnah',
      completionStatus: DuaCompletionStatus.complete,
    ...
    DuaItem(
      ...
      difficulty: DuaDifficulty.beginner,
      tags: <String>['character', 'akhlaq', 'guidance', 'self_purification'],
      audioKey: '',
      isCore: false,
      verificationStatus: 'source_seeded_sunnah',
      completionStatus: DuaCompletionStatus.complete,
    ...
    DuaItem(
      ...
      audioKey: 'quran_026_083_085_grant_me_wisdom_and_a_lasting_good_name.mp3',
      isCore: false,
      verificationStatus: 'source_seeded_quran_foundation',
      completionStatus: DuaCompletionStatus.complete,
    ),
    ...
    DuaItem(
      ...
      audioKey: 'quran_029_030_support_me_against_the_corrupting_people.mp3',
      isCore: false,
      verificationStatus: 'source_seeded_quran_foundation',
      completionStatus: DuaCompletionStatus.complete,
    ),
    ...
    DuaItem(
      ...
      audioKey: 'quran_038_035_forgive_me_and_grant_me_a_unique_kingdom.mp3',
      isCore: false,
      verificationStatus: 'source_seeded_quran_foundation',
      completionStatus: DuaCompletionStatus.complete,
    ),
    ...
    DuaItem(
      ...
      difficulty: DuaDifficulty.advanced,
      tags: <String>['quran', 'gratitude', 'children', 'repentance', 'parents'],
      audioKey:
    ...
    DuaItem(
      ...
      translation:
          'Our Lord, forgive us and our brothers who preceded us in faith, and do not place in our hearts any resentment toward those who believe. Our Lord, indeed You are Kind and Merciful.',
      whenToSay: 'For unity of heart, forgiveness, and love for the believers.',
      sourceType: 'quran',
      sourceRef: 'Qur\'an 59:10',
      difficulty: DuaDifficulty.intermediate,
