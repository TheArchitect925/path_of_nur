...
const List<HadithCollection> seededHadithCollections = [
  ...
  HadithCollection(
    id: 'heart_softening',
    title: 'Heart Softening',
    subtitle:
        'Reflective hadith for repentance, remembrance, and the hereafter.',
    description:
        'A reflective set centered on accountability, remembrance, repentance, and preparing the heart for the meeting with Allah.',
    hadithIds: [
      'accountability_day_of_judgment',
      'allah_accepts_repentance_night_day',
      'allah_remembers_those_who_remember_him',
