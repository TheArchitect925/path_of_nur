...
class HadithThemePage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final theme = hadithThemeById(themeId);
    if (theme == null) {
    ...
    final subcategories = hadithSubcategoriesForTheme(theme.id);
    final progress = ref.watch(hadithThemeProgressProvider(theme.id));

    HadithSubcategory? nextSubcategory;
    for (final sub in subcategories) {
      final p = ref.watch(hadithSubcategoryProgressProvider(sub.id));
