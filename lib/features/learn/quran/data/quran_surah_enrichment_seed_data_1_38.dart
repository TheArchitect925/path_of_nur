...
seededQuranSurahEnrichments1To38 = <QuranSurahEnrichmentSeed>[
  ...
  QuranSurahEnrichmentSeed(
    ...
    reflections: <QuranSurahReflectionPrompt>[
      QuranSurahReflectionPrompt(
        prompt:
            'Which commands of Allah am I following outwardly but still resisting inwardly?',
      ),
      QuranSurahReflectionPrompt(
  ...
  QuranSurahEnrichmentSeed(
    ...
    reflections: <QuranSurahReflectionPrompt>[
      QuranSurahReflectionPrompt(
        prompt:
            'Where is Allah teaching me patience through a season I wish would end sooner?',
      ),
    ],
  ),
  QuranSurahEnrichmentSeed(
    ...
    notableAyat: <QuranSurahNotableAyah>[
      ...
      QuranSurahNotableAyah(
        ...
        whyItMatters: 'A key verse on human dignity and responsibility.',
        evidenceLevel: QuranSurahContentEvidenceLevel.quranExplicit,
      ),
      QuranSurahNotableAyah(
        surahNumber: 17,
  ...
  QuranSurahEnrichmentSeed(
    ...
    reflections: <QuranSurahReflectionPrompt>[
      QuranSurahReflectionPrompt(
        prompt:
            'Which trial of faith, wealth, knowledge, or power needs more humility from me?',
      ),
    ],
  ...
  QuranSurahEnrichmentSeed(
    ...
    notableAyat: <QuranSurahNotableAyah>[
      QuranSurahNotableAyah(
        ...
        whyItMatters: 'A key verse connecting salah to remembering Allah.',
        evidenceLevel: QuranSurahContentEvidenceLevel.quranExplicit,
      ),
      QuranSurahNotableAyah(
        surahNumber: 20,
