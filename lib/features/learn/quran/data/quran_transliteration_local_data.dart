// Generated from trusted transliteration source: AlQuran.cloud (edition: en.transliteration).
// This file is intentionally bundled to keep Qur'an transliteration search deterministic and offline-safe.

const Map<int, List<String>> quranTransliterationLocalData = {
  1: <String>[
