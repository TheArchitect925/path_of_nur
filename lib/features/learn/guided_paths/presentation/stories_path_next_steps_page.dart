...
class StoriesPathNextStepsPage extends ConsumerWidget {
      ...
      children: [
        PremiumCard(
          child: Column(
            ...
            children: [
              Text(
                l10n.learnStoriesPathNextStepsIntroTitle,
                style: Theme.of(
                  context,
                ).textTheme.titleSmall?.copyWith(fontWeight: FontWeight.w700),
              ),
              const SizedBox(height: 8),
              Text(l10n.learnStoriesPathNextStepsIntroBody),
              const SizedBox(height: 14),
              FilledButton.icon(
                onPressed: () {
                  analytics.logPrimaryCardOpened(
                    cardId: 'history_archive',
                    sourceSurface: 'stories_next_steps',
                    domain: 'stories',
                  );
                  context.pushNamed('learnHistoryArchive');
                },
                icon: const Icon(Icons.history_edu_rounded),
                label: Text(l10n.learnStoriesPathNextStepsHistoryAction),
              ),
            ],
          ),
        ),
        ...
        PremiumCard(
          child: Column(
            ...
            children: [
              Text(
                l10n.learnStoriesPathNextStepsSectionTitle,
                style: Theme.of(
                  context,
                ).textTheme.titleSmall?.copyWith(fontWeight: FontWeight.w700),
              ),
              ...
              Text(
                l10n.learnStoriesPathNextStepsSectionSubtitle,
  ...
  String _helperTextForPath(BuildContext context, String pathId) {
    ...
    return switch (pathId) {
      'character-starter' => l10n.learnStoriesPathNextStepsCharacterHint,
      'quran-beginner-starter' => l10n.learnStoriesPathNextStepsQuranHint,
      _ => '',
    };
  }
}
