...
List<GrowthHabit> seasonalGrowthHabits = const [
  ...
  GrowthHabit(
    ...
    subtitle: 'Stand in night prayer during Ramadan.',
  ...
  GrowthHabit(
    id: 's_friday_jumuah',
    title: 'Attend Jumuʿah Prayer',
    subtitle: 'Protect the weekly congregational prayer.',
  ...
  GrowthHabit(
    ...
    title: 'Extra Prayer',
    subtitle: 'Add voluntary prayer in the ten days.',
    description: 'Protect one extra prayer each day.',
    category: GrowthHabitCategory.sunnahPractices,
    pathIds: ['seasonal-dhul-hijjah'],
    recurrenceType: GrowthHabitRecurrenceType.daily,
    weekdays: [1, 2, 3, 4, 5, 6, 7],
