...
class JourneyLegacyPage extends ConsumerStatefulWidget {
  const JourneyLegacyPage({super.key});

  @override
  ConsumerState<JourneyLegacyPage> createState() => _JourneyLegacyPageState();
}

class _JourneyLegacyPageState extends ConsumerState<JourneyLegacyPage> {
