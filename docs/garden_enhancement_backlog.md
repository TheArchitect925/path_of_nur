# Garden Enhancement Backlog

1. Replace the V1 fallback artwork with the final 10 curated Garden images under `assets/images/garden/`.
2. Add optional swipe navigation between unlocked Garden images inside the fullscreen viewer if the final UX pass still wants it.
