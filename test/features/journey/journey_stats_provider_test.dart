...
void main() {
  test('journey stats aggregate lifetime adhkar from tracked completions', () async {
  ...
  test('journey stats reflect install age against trustworthy tracked time', () async {
    final database = AppDatabase.inMemory();
    addTearDown(database.close);
    database.execute(
      '''
