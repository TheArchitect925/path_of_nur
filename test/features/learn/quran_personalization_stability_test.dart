...
void main() {
  ...
  test(
    'recording a presentation does not change the primary (no churn)',
    () async {
      ...
      final notifier = container.read(
        quranPersonalizationStateProvider.notifier,
      );
  ...
  test(
    'dismiss removes exactly the presented primary and never resurfaces it',
    () async {
      final container = await makeTestContainer();
      addTearDown(container.dispose);
