...
void main() {
  ...
  test('settings focus regression coverage includes diagnostics-safe support lane', () {
    ...
    expect(
      settingsScenario.orderedSectionIds,
      <String>[
        'settings.startup',
        'settings.listening',
        'settings.support',
  ...
  test('all active focus QA scenarios expect navigation and content restore', () {
    for (final scenario in activeTVOSFocusQaScenarios()) {
      ...
      expect(
        ...
        isTrue,
        reason: 'Expected navigation restore coverage for ${scenario.routePath}',
      );
    }
  });
  ...
  test('all active focus QA scenarios use medium-or-higher risk classification', () {
