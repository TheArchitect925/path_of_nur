...
void main() {
  test(
    'kids lesson packs stay reachable through existing Arabic routes',
    () async {
      ...
      expect(
        packs
            .firstWhere((pack) => pack.id == 'kids_daily_words_theme_pack')
            .type,
      ...
      expect(
        packs
            .firstWhere(
              (pack) => pack.id == 'kids_quran_linked_words_theme_pack',
            )
            .itemIds,
      ...
      expect(
        packs
            .firstWhere((pack) => pack.id == 'kids_review_pack')
            .primaryTarget
            .routeName,
        'kidsArabicReview',
      );
  ...
  test(
    'adult lesson packs point to existing adult modules and bridge owners',
    () async {
      final container = await makeTestContainer();
      addTearDown(container.dispose);
      ...
      expect(
        packs
            .firstWhere((pack) => pack.id == 'adult_review_pack')
            .primaryTarget
            .kind,
      ...
      expect(
        packs
            .firstWhere((pack) => pack.id == 'adult_quran_readiness_pack')
            .type,
        ArabicLearningLessonPackType.bridge,
      );
      expect(
        packs
            .firstWhere((pack) => pack.id == 'adult_prayer_words_theme_pack')
            .type,
        ArabicLearningLessonPackType.theme,
      );
      expect(
