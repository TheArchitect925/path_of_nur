...
void main() {
  ...
  test('parent overview reflects recent progress, milestone, and practiced today', () async {
    final container = await makeTestContainer(
      overrides: [
        kidsArabicNowProvider.overrideWithValue(() => DateTime(2026, 3, 24, 9)),
      ],
    ...
    final progressNotifier = container.read(kidsArabicProgressProvider.notifier);
